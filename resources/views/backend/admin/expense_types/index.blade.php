...
@section('meta_title', 'Expense Types')
...
<div class="d-flex justify-content-end">
    ...
    <a href="{{route('admin.expense_types.create')}}" title="Add Category" class="btn btn-primary action-btn">Add Expense
        Type</a>
    @endcan
</div>
@endsection
...
<script>
    $(function() {
            var table = $('.data-table').DataTable({
                ...
                ajax: `/admin/expense_types?trash=0`,
                columns: [{
                        data: "plus-icon",
                        name: "plus-icon",
                        defaultContent: null
        ...
        $(document).on('change', '.trashswitch', function () {
            ...
            table.ajax.url('/admin/expense_types?trash=' + trash).load();
        });
        ...
        $(document).on('click', '.trash', function (e) {
            ...
            swal("Are you sure, you want to trash?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/expense_types/' + id + '/trash',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
        ...
        $(document).on('click', '.restore', function (e) {
            ...
            swal("Are you sure, you want to restore?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/expense_types/' + id + '/restore',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
