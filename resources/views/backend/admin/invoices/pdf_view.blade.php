...
<body>
        ...
        <table class="table table-bordered ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> @foreach($otherservices as $data ) {{$sign1}} {{$data['total']}} {{$sign2}},   @endforeach </td>
                </tr>

                <tr style="background-color: #ffc107">
                    <td colspan="2">Other Services Total </td>
                    <td> {{$sign1}} {{$other_charges_total}} {{$sign2}} </td>
                </tr>

                <tr>
                    <td colspan="2">Commercial tax ({{$commercial_tax}}  %)</td>
                    <td> {{$sign1}} {{$grandtotal}} {{$sign2}}</td>
                </tr>
                
                <tr>
                    <td colspan="2">Grand Total</td>
                    <td>{{$sign1}} {{$other_charges_total+$grandtotal}} {{$sign2}}</td>
                </tr>
    ...
    <div class="total_invoice">
        <h2 class="total_invoice"> <span class="total"> Invoice Total: </span> {{$sign1}} {{$other_charges_total+$grandtotal}} {{$sign2}} </h2>
        <h3> Address</h3>
