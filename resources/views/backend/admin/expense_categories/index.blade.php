...
@section('page_title', 'Expense Cateogries')
...
<div class="d-flex justify-content-end">
    ...
    <a href="{{route('admin.expense_categories.create')}}" title="Add Expense Category" class="btn btn-primary action-btn">Add Expense Category</a>
    @endcan
</div>
@endsection
...
<script>
    $(function() {
            var table = $('.data-table').DataTable({
                ...
                ajax: `/admin/expense_categories?trash=0`,
                columns: [{
                        data: "plus-icon",
                        name: "plus-icon",
                        defaultContent: null
        ...
        $(document).on('change', '.trashswitch', function () {
            ...
            table.ajax.url('/admin/expense_categories?trash=' + trash).load();
        });
        ...
        $(document).on('click', '.trash', function (e) {
            ...
            swal("Are you sure, you want to trash?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/expense_categories/' + id + '/trash',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
        ...
        $(document).on('click', '.restore', function (e) {
            ...
            swal("Are you sure, you want to restore?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/expense_categories/' + id + '/restore',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
        ...
        $(document).on('click', '.destroy', function (e) {
            ...
            swal("Are you sure, you want to delete?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/expense_categories/' + id,
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
