...
@section('meta_title', 'Room Layout')
@section('page_title', 'Room Layout')
...
<div class="d-flex justify-content-end">
    ...
    @can('add_room_layout')
    <a href="{{route('admin.roomlayouts.create')}}" title="Add Room No" class="btn btn-primary action-btn">Add Room
        Layout </a>
    @endcan
</div>
@endsection
...
<script>
    $(function() {
            var table = $('.data-table').DataTable({
                ...
                ajax: `/admin/roomlayouts?trash=0`,
                columns: [{
                        data: "plus-icon",
                        name: "plus-icon",
                        defaultContent: null
        ...
        $(document).on('change', '.trashswitch', function () {
            ...
            table.ajax.url('/admin/roomlayouts?trash=' + trash).load();
        });
        ...
        $(document).on('click', '.trash', function (e) {
            ...
            swal("Are you sure, you want to trash?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/roomlayouts/' + id + '/trash',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
        ...
        $(document).on('click', '.restore', function (e) {
            ...
            swal("Are you sure, you want to restore?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/roomlayouts/' + id + '/restore',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
