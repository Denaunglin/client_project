...
<div class="d-flex justify-content-end">
    ...
    <a href="{{route('admin.slider_upload.create')}}" title="Add Sliders" class="btn btn-primary action-btn">Add Sliders</a>
    @endcan
</div>
@endsection
...
<script>
    $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: `/admin/slider_upload?trash=0`,
                columns: [{
                        data: "plus-icon",
                        name: "plus-icon",
                        defaultContent: null
        ...
        $(document).on('change', '.trashswitch', function () {
            ...
            table.ajax.url('/admin/slider_upload?trash=' + trash).load();
        });
        ...
        $(document).on('click', '.trash', function (e) {
            ...
            swal("Are you sure, you want to trash?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/slider_upload/' + id + '/trash',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
        ...
        $(document).on('click', '.restore', function (e) {
            ...
            swal("Are you sure, you want to restore?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/slider_upload/' + id + '/restore',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
