...
<div class="d-flex justify-content-end">
    ...
    <a href="{{route('admin.earlylatechecks.create')}}" title="Add EarlyLateCheck" class="btn btn-primary action-btn">Add Early / Late-Check Prices</a>
    @endcan
</div>
@endsection
                    ...
                    <table class="align-middle table data-table">
                        <thead>
                            <tr>
                                <th></th>
                                <th>User</th>
                                <th>Add Early Check-in price </th>
                                <th>Add Late Check-out price Price </th>
                                <th>Subtract Early Check-in price </th>
                                <th>Subtract Late Check-out price Price </th>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                     ...
                     {
                        data: 'add_early_checkin',
                        name: 'add_early_checkin',
                        defaultContent: "-",
                        class: ""
                    },
                   
                     {
                        data: 'add_late_checkout',
                        name: 'add_late_checkout',
                        defaultContent: "-",
                        class: ""
                    },
                   
                      {
                        data: 'subtract_early_checkin',
                        name: 'subtract_early_checkin',
                        defaultContent: "-",
                        class: ""
                    },
                   
                     {
                        data: 'subtract_late_checkout',
                        name: 'subtract_late_checkout',
                        defaultContent: "-",
                        class: ""
                    },
