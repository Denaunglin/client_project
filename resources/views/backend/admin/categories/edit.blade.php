                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_my" id="name_my" class="form-control"
                                    value="{{old('name_my') ?? $encoded->my}}" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="parent_id" id="parent_id">
                                    ...
                                    @endphp
                                    <option value="{{$each_category->id}}" @if($each_category->id ==
                                        $category->parent_id) selected @endif>{{$category_decoded->my}}
                                        ({{$category_decoded->en}})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
