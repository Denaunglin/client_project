                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="parent_id" id="parent_id">
                                    ...
                                    @endphp
                                    <option value="{{$each_category->id}}">{{$category_decoded->my}}
...
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\StoreCategory', '#form') !!}
@endsection
