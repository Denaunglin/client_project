...
<div class="d-flex justify-content-end">
    ...
    <a href="{{route('admin.cardtypes.create')}}" title="Add Category" class="btn btn-primary action-btn">Add Card
        Type</a>
    @endcan
</div>
@endsection
...
<script>
    $(function() {
        ...
        $(document).on('change', '.trashswitch', function () {
            ...
            table.ajax.url('/admin/cardtypes?trash=' + trash).load();
        });
        ...
        $(document).on('click', '.restore', function (e) {
            ...
            swal("Are you sure, you want to restore?", {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/admin/cardtypes/' + id + '/restore',
                            type: 'GET',
                            success: function () {
                                table.ajax.reload();
                            }
