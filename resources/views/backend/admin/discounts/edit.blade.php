...
@section('meta_title', 'Edit Discount & Addon ')
@section('page_title', 'Edit Discount & Addon ')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <option value="{{$data->id}}"  @if($discount->room_type_id==$data->id) selected  @endif >{{$data->roomtype->name}} / {{$data->bedtype->name}}</option>
                                    @empty
                                    <option >There is no data !</option>
                                    @endforelse
                                </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        <input type="number" value="{{$discount->discount_percentage_foreign}}"  step="any" id="discount_percentage_foreign" name="discount_percentage_foreign" class="form-control">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="number" value="{{$discount->discount_amount_foreign}}"  step="any" id="discount_amount_foreign" name="discount_amount_foreign" class="form-control">
                                  </div>
                              </div>
                          </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        <input type="number" value="{{$discount->addon_percentage_mm}}" step="any" id="addon_percentage_mm" name="addon_percentage_mm" class="form-control">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">%</span>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        <input type="number"  value="{{$discount->addon_percentage_foreign}}" step="any" id="addon_percentage_foreign" name="addon_percentage_foreign" class="form-control">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <input type="number" value="{{$discount->addon_amount_mm}}" step="any" id="addon_amount_mm" name="addon_amount_mm" class="form-control">
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label>Addon Amount Foreign</label>
                                  <input type="number" value="{{$discount->addon_amount_foreign}}"  step="any" id="addon_amount_foreign" name="addon_amount_foreign" class="form-control">
                                  </div>
                              </div>
                          </div>
                        </div>
